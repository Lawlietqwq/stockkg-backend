...
package com.example.database.idgenerator.config;

import com.example.common.tools.ApplicationContextHolder;
import com.example.database.idgenerator.snowflake.LocalRedisWorkIdChoose;
import com.example.database.idgenerator.snowflake.RandomWorkIdChoose;
