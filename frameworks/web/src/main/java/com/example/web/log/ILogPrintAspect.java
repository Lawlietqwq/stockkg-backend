...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.example.web.annotations.ILog) || @annotation(com.example.web.annotations.ILog)")
    public Object printMLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (logAnnotation != null) {
                ...
                log.info("[{}] {}, executeTime: {}ms, info: {}", methodType, requestURI, SystemClock.now() - startTime, JsonUtil.objToJson(logPrint));
            }
        }
        return result;
    }
